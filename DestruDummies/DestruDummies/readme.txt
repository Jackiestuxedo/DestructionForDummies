========================================================================
    PROJET MAKEFILE : Vue d'ensemble du projet DestruDummies
========================================================================

AppWizard a créé ce projet DestruDummies pour vous. 

Ce fichier contient un résumé du contenu de chacun des fichiers qui constituent votre projet DestruDummies.


DestruDummies.vcxproj
...
Ce projet vous permet de générer/nettoyer/régénérer à partir de Visual Studio en appelant les commandes que vous avez entrées dans l'Assistant. La commande de génération peut être nmake ou tout autre outil utilisé.

Ce projet ne contient pas de fichiers, c'est pourquoi rien ne s'affiche dans l'Explorateur de solutions.
